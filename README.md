...
This repository contains the source code for the C# rewrite of MicroWin. This serves as the continuation of MicroWin from [WinUtil](https://github.com/ChrisTitusTech/winutil).

If you encounter an issue, or want to suggest a new feature, don't hesitate to send feedback!
